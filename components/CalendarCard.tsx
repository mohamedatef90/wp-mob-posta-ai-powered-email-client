...
const CalendarCard: React.FC<CalendarCardProps> = ({ participants, onClose, suggestedDetails, isLoading }) => {
    ...
    return (
        <div className="bg-card border border-border rounded-xl p-4 animate-fadeInUp">
            ...
            <div className="flex justify-end gap-2 mt-6">
                <button onClick={onClose} className="px-4 py-2 rounded-lg text-sm font-semibold hover:bg-accent w-auto">Cancel</button>
                <button onClick={onClose} className="bg-primary text-primary-foreground px-4 py-2 rounded-lg text-sm font-semibold hover:bg-primary/90 flex items-center justify-center space-x-2 w-auto">
